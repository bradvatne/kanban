      ...
      <div className="flex-1 flex flex-col w-full max-w-sm justify-center gap-2">
        {view === "check-email" ? (
          ...
          >
            ...
            <input
              className="rounded-md px-4 py-2 bg-inherit border mb-6 text-black dark:text-mediumgrey"
              type="password"
              name="password"
            ...
            {view === "sign-in" ? (
              <>
                <button className="bg-purple hover:bg-purplehover rounded px-4 py-2 text-neutral-200 mb-6">
                  Sign In
                </button>
